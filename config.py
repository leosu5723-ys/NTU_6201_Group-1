...
MODEL = "google/gemini-2.5-flash-lite"  # only used when BACKEND == "live"
BASE_URL = "https://openrouter.ai/api/v1"
PROMPT_VERSION = "v2"         # "v1" only for the controlled D2(b) comparison
PROJECT_URL = "https://github.com/leosu5723-ys/NTU_6201_Group-1"

# Your key never goes in this file. Put it in the environment:
#     export OPENROUTER_API_KEY="<your key>"
# In Colab:  os.environ["OPENROUTER_API_KEY"] = "<your key>"
...
MONTHLY_API_BUDGET_PER_MEMBER_USD = 25.0  # team operational ceiling per API-key owner
